 ...
 */
public class MDCInsertingServletFilterCustomize extends MDCInsertingServletFilter implements Filter {
	...
	void insertIntoMDC(ServletRequest request) {
		...
		if (request instanceof HttpServletRequest) {
			...
			MDC.put(ClassicConstants.REQUEST_X_FORWARDED_FOR, ipAddress);
		}
