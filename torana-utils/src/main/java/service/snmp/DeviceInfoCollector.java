...
import snmp.oid.config.OIDConfiguration;
import snmp.oid.config.OidLoader;
...
public class DeviceInfoCollector {
    ...
    public DeviceInfoCollector(String ipAddr , String snmpPort , String community , Integer snmpVersion )
    {
    ...
    public System setValuesToSystem(String name) throws IllegalAccessException, IOException {
         System aSystem = new snmp.domain.System();
